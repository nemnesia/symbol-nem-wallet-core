...
function packageInventory(manifest, entry) {
  const packageSources = [
    ...
    "android/OnLoad.cpp",
    "android/SymbolNemWalletCoreCxxReactPackage.cpp",
    "android/SymbolNemWalletCoreCxxReactPackage.h",
    "android/build.gradle",
    "android/src/main/java/com/nemnesia/symbolnemwalletcore/SymbolNemWalletCoreCxxReactPackage.kt",
    "android/src/main/java/com/nemnesia/symbolnemwalletcore/SymbolNemWalletCoreRnLifecycle.kt",
    ...
    "ios/SnwcNativeSymbolNemWalletCore.cpp",
    "ios/SnwcNativeSymbolNemWalletCoreProvider.cpp",
